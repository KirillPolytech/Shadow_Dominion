...
namespace Shadow_Dominion
{
    public class LegPlacer : MonoBehaviour
    {
        ...
        [Space] [Header("LFoot")] [SerializeField]
        private Transform LFootPos;
        ...
        [Space] [Header("RFoot")] [SerializeField]
        private Transform RFootPos;
        ...
        public void Step()
        {
            ...
            Quaternion targetRot = Quaternion.Euler(LFootPos.eulerAngles.x,
